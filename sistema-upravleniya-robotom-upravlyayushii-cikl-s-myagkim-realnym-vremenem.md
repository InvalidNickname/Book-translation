...
| ![](.gitbook/assets/image%20%288%29.png) | _Никогда_ не используйте блокировку потоков в системах реального \(строгого или нет\) времени. Всегда опрашивайте \(poll\) интерфейсы для получения данных. |
| :--- | :--- |
